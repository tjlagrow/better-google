...
class IXIDataset(Dataset):
    self.T1_filenames = [(patient1, 0), (patient1, 1), ..., (patient1, 149), (patient2, 0)]
    self.T2_filenames = []
    ...
    def __getitem__(self, index):
        # 256x256 image, 256x256 image
        # load in the image, process the image, resize it, ...
        T1_image = Image.load(self.T1_filenames[index])
        T2_image = Image.load(self.T2_filenames[index])
